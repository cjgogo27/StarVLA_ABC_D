...
DATASET_NAMED_MIXTURES = {
    ...
    # ABC->D benchmark training split. The LeRobot directory name is inherited
    # from the converted dataset, but it is converted from task_ABC_D/training
    # and must not include Calvin D validation/test data.
    "calvin_task_ABC_only": [
        ("calvin_task_ABC_D", 1.0, "libero_franka"),
    ],
