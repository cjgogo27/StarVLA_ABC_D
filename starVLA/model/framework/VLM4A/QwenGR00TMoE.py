...
"""
Qwen-GR00T-MoE Framework

Isolated QwenGR00T variant that swaps only the action decoder for a small MoE
decoder. Shared GR00T parameter names are preserved for checkpoint
initialization from a trained QwenGR00T model.
"""
...
@dataclass
class QwenGR00TMoEDefaultConfig:
    name: str = "QwenGR00TMoE"
...
@FRAMEWORK_REGISTRY.register("QwenGR00TMoE")
@FRAMEWORK_REGISTRY.register("QwenMoE")
class Qwen_GR00T_MoE(baseframework):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super().__init__()
        self.config = merge_framework_config(QwenGR00TMoEDefaultConfig, config)
