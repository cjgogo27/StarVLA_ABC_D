...
# Strong visual augmentation run for ABC -> D generalization.
# Keeps the original QwenGR00T Calvin script untouched.
...
run_id=qwen35vl4b_gr00t_calvin_abc_d_strong_aug_from30000_new_lr_sched
