...
run_id=qwen35vl4b_gr00t_calvin_abc_d_strong_aug_steps30000_mot_state_adapter
pretrained_checkpoint=/inspire/qb-ilm2/project/26summer-camp-10/public/two/starVLA/results/Checkpoints/qwen35vl4b_gr00t_calvin_abc_d_strong_aug/checkpoints/steps_30000_pytorch_model.pt

# Keep the strong policy's state-conditioned action head active. Train the new
# state-history MOT adapter plus the action head; freeze only Qwen.
...
"${ACCELERATE_BIN}" launch \
  ...
  --trainer.learning_rate.action_model 2.0e-05 \
