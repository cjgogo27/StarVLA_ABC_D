...
# Qwen3.5 + GR00T-MoE-Progress post-train.
# Isolated progress-token variant; VLM is frozen by default.
...
run_id=${RUN_ID:-qwen35vl4b_gr00t_moe_progress_calvin_abc_d_from_strong_aug}
